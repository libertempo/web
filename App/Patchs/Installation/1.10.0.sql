...
INSERT INTO `conges_config` VALUES ( 'texte_haut_edition_papier', '- Libertempo : édition des congés -', '11_Editions papier', 'texte', 'config_comment_texte_haut_edition_papier' );
INSERT INTO `conges_config` VALUES ( 'texte_bas_edition_papier', '- édité par Libertempo -', '11_Editions papier', 'texte', 'config_comment_texte_bas_edition_papier' );
...
INSERT INTO `conges_mail` VALUES ( 'mail_new_demande_resp_absent', 'APPLI CONGES - Demande de congés', ' __SENDER_NAME__ a solicité une demande de congés dans l\'application de gestion des congés.
